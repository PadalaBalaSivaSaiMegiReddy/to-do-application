...
const App = () => {
	...
	return (
		<div className={`p-10 ${checked === false ? "light" : "dark"}`}>
			...
			<div
				className={`container no-scrollbar overflow-y-scroll m-10 mx-auto max-w-[650px] min-h-[500px] max-h-[500px] bg-[#f1f5f8] shadow-2xl rounded-xl bg-[url('https://www.transparenttextures.com/patterns/worn-dots.png')] ${
